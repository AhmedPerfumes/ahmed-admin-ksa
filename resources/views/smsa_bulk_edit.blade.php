            ...
            @if(empty($order->awb))
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="country_code[]" value="SA" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <label class="pb-text">Customs Declared Value (SAR)</label>
                        <input type="text" class="form-control" name="declared_value[]" value="{{ $declared_value }}" required="">
                    </div>
                    <div class="col">
                        <label class="pb-text">Total Cash on Delivery (SAR)</label>
